...
set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports da_mclk]
set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports da_lrclk]
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33} [get_ports da_sclk]
set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports da_sdi]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports ad_mclk]
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports ad_lrclk]
set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports ad_sclk]
set_property -dict {PACKAGE_PIN W19 IOSTANDARD LVCMOS33} [get_ports ad_sdo]
