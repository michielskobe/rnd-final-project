...
entity bd_f66c is
  ...
  attribute CORE_GENERATION_INFO of bd_f66c : entity is "bd_f66c,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_f66c,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_f66c : entity is "design_1_system_ila_2_1.hwdef";
end bd_f66c;

architecture STRUCTURE of bd_f66c is
  component bd_f66c_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 23 downto 0 );
    probe1 : in STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  end component bd_f66c_ila_lib_0;
...
begin
  ...
  probe2_1(0) <= probe2(0);
  probe3_1(0) <= probe3(0);
ila_lib: component bd_f66c_ila_lib_0
     port map (
      clk => clk_1,
