...
architecture STRUCTURE of bd_f60c is
  ...
  signal probe1_1 : STD_LOGIC_VECTOR ( 127 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_0_pl_clk0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
begin
  clk_1 <= clk;
  probe0_1(0) <= probe0(0);
  probe1_1(127 downto 0) <= probe1(127 downto 0);
  probe2_1(0) <= probe2(0);
  probe3_1(0) <= probe3(0);
...
ila_lib: component bd_f60c_ila_lib_0
     port map (
      clk => clk_1,
      probe0(0) => probe0_1(0),
      probe1(127 downto 0) => probe1_1(127 downto 0),
      probe2(0) => probe2_1(0),
      probe3(0) => probe3_1(0),
      probe4(23 downto 0) => probe4_1(23 downto 0),
