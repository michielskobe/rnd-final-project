...
# Bank 501
set_property -dict { PACKAGE_PIN D10 IOSTANDARD LVCMOS18 } [get_ports {MIO36_PS_GPIO1_0       }];  # "D10.MIO36_PS_GPIO1_0"
set_property -dict { PACKAGE_PIN E11 IOSTANDARD LVCMOS18 } [get_ports {MIO37_PS_GPIO1_1       }];  # "E11.MIO37_PS_GPIO1_1"
set_property -dict { PACKAGE_PIN C10 IOSTANDARD LVCMOS18 } [get_ports {MIO39_PS_GPIO1_2       }];  # "C10.MIO39_PS_GPIO1_2"
set_property -dict { PACKAGE_PIN D11 IOSTANDARD LVCMOS18 } [get_ports {MIO40_PS_GPIO1_3       }];  # "D11.MIO40_PS_GPIO1_3"
set_property -dict { PACKAGE_PIN B11 IOSTANDARD LVCMOS18 } [get_ports {MIO44_PS_GPIO1_4       }];  # "B11.MIO44_PS_GPIO1_4"
set_property -dict { PACKAGE_PIN A11 IOSTANDARD LVCMOS18 } [get_ports {MIO45_PS_GPIO1_5       }];  # "A11.MIO45_PS_GPIO1_5"
set_property -dict { PACKAGE_PIN C9  IOSTANDARD LVCMOS18 } [get_ports {MIO38_SPI0_SCLK        }];  # "C9.MIO38_SPI0_SCLK"
set_property -dict { PACKAGE_PIN B10 IOSTANDARD LVCMOS18 } [get_ports {MIO41_SPI0_CS          }];  # "B10.MIO41_SPI0_CS"
set_property -dict { PACKAGE_PIN D12 IOSTANDARD LVCMOS18 } [get_ports {MIO42_SPI0_MISO        }];  # "D12.MIO42_SPI0_MISO"
set_property -dict { PACKAGE_PIN E13 IOSTANDARD LVCMOS18 } [get_ports {MIO43_SPI0_MOSI        }];  # "E13.MIO43_SPI0_MOSI"