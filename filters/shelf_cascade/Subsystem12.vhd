-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/shelf_cascade/Subsystem12.vhd
...
-- 
-- Module: Subsystem12
-- Source Path: shelf_cascade/Subsystem16/Subsystem12
-- Hierarchy Level: 2
-- Model version: 1.20
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF Subsystem12 IS

  -- Signals
  SIGNAL enb_gated                        : std_logic;
  SIGNAL Enable_out9                      : std_logic;
  SIGNAL alpha2K_V_1_signed               : signed(28 DOWNTO 0);  -- sfix29_En23
  SIGNAL Cm_signed                        : signed(26 DOWNTO 0);  -- sfix27_En23
  SIGNAL Product6_mul_temp                : signed(55 DOWNTO 0);  -- sfix56_En46
  SIGNAL alpha2KCm_V_1                    : signed(28 DOWNTO 0);  -- sfix29_En23
  ...
  SIGNAL DataIn_signed                    : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL alpha1_a0_signed                 : signed(28 DOWNTO 0);  -- sfix29_En23
  SIGNAL Product7_mul_temp                : signed(60 DOWNTO 0);  -- sfix61_En46
  ...
  SIGNAL Unary_Minus2_cast                : signed(32 DOWNTO 0);  -- sfix33_En23
  SIGNAL Unary_Minus2_cast_1              : signed(32 DOWNTO 0);  -- sfix33_En23
  SIGNAL Unary_Minus2_out1                : signed(31 DOWNTO 0);  -- sfix32_En23
  ...
  SIGNAL a2_signed                        : signed(28 DOWNTO 0);  -- sfix29_En23
  SIGNAL Unary_Minus_cast                 : signed(29 DOWNTO 0);  -- sfix30_En23
  SIGNAL Unary_Minus_cast_1               : signed(29 DOWNTO 0);  -- sfix30_En23
  SIGNAL Unary_Minus_out1                 : signed(28 DOWNTO 0);  -- sfix29_En23
  SIGNAL a1_signed                        : signed(28 DOWNTO 0);  -- sfix29_En23
  SIGNAL Product8_out1                    : signed(26 DOWNTO 0);  -- sfix27_En23
  SIGNAL Product4_mul_temp                : signed(55 DOWNTO 0);  -- sfix56_En46
  ...
  SIGNAL Product8_mul_temp                : signed(60 DOWNTO 0);  -- sfix61_En46
  SIGNAL Delay4_out1                      : signed(26 DOWNTO 0);  -- sfix27_En23
  SIGNAL Product5_mul_temp                : signed(55 DOWNTO 0);  -- sfix56_En46
...
BEGIN
  ...
  alpha2KCm_V_1 <= Product6_mul_temp(51 DOWNTO 23);
  ...
  Unary_Minus2_cast <= resize(alpha2K_not_ascii_V_2V_1_2_signed, 33);
  Unary_Minus2_cast_1 <=  - (Unary_Minus2_cast);
  Unary_Minus2_out1 <= Unary_Minus2_cast_1(31 DOWNTO 0);
  ...
  Product2_mul_temp <= Delay2_out1 * Unary_Minus2_out1;
