-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/shelf_cascade/Subsystem13.vhd
...
-- 
-- Module: Subsystem13
-- Source Path: shelf_cascade/Subsystem16/Subsystem13
-- Hierarchy Level: 2
-- Model version: 1.20
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF Subsystem13 IS
  ...
  SIGNAL Sum5_op_stage1                   : signed(29 DOWNTO 0);  -- sfix30_En23
  SIGNAL Product_mul_temp                 : signed(53 DOWNTO 0);  -- sfix54_En46
  SIGNAL K_not_ascii                      : signed(28 DOWNTO 0);  -- sfix29_En23
  ...
  SIGNAL Product10_mul_temp               : signed(60 DOWNTO 0);  -- sfix61_En46
  SIGNAL K_not_ascii_V_2V_1               : signed(28 DOWNTO 0);  -- sfix29_En23
  SIGNAL Constant13_out1                  : signed(26 DOWNTO 0);  -- sfix27_En23
  SIGNAL Product11_mul_temp               : signed(55 DOWNTO 0);  -- sfix56_En46
  SIGNAL alpha2K_not_ascii_V_2V_1         : signed(28 DOWNTO 0);  -- sfix29_En23
  ...
  SIGNAL alpha2K                          : signed(28 DOWNTO 0);  -- sfix29_En23
  ...
  SIGNAL alpha2K_V_1_tmp                  : signed(28 DOWNTO 0);  -- sfix29_En23
...
BEGIN
  ...
  V_not_ascii <= Product8_mul_temp(51 DOWNTO 23);

  Constant8_out1 <= to_signed(16#1000000#, 27);

  Product9_mul_temp <= V_signed * Constant8_out1;
  alpha2V <= Product9_mul_temp(51 DOWNTO 23);
  ...
  Sum5_op_stage1 <= Sum5_stage2_add_temp(29 DOWNTO 0);

  Product_mul_temp <= K_signed * K_signed;
  K_not_ascii <= Product_mul_temp(51 DOWNTO 23);
  ...
  K_not_ascii_V_2V_1 <= Product10_mul_temp(51 DOWNTO 23);

  Constant13_out1 <= to_signed(16#1000000#, 27);

  Product11_mul_temp <= K_not_ascii_V_2V_1 * Constant13_out1;
  alpha2K_not_ascii_V_2V_1 <= Product11_mul_temp(51 DOWNTO 23);
  ...
  alpha2K <= Product6_mul_temp(51 DOWNTO 23);
  ...
  alpha2K_V_1_tmp <= Product7_mul_temp(51 DOWNTO 23);
